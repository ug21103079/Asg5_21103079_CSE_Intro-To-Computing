...
root=Tk()
root.geometry("400x400") #Defining Size of GUI Window
root.minsize(400,400) #Setting Minimum Limit of GUI Window Size
root.maxsize(400,400) #Setting Maximum Limit of GUI Window Size
